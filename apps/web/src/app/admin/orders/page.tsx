...
export default function AdminOrdersPage() {
    ...
    const filteredOrders = orders.filter(order =>
        ...
        order.retailer?.businessName?.toLowerCase().includes(search.toLowerCase())
    )
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                <div>
                    <h1 className="text-xl md:text-2xl font-bold text-gray-900">Orders Hub</h1>
                    <p className="text-sm text-gray-500 mt-1">Manage and track all requested orders generated by Retailers</p>
                </div>
            </div>
                            ...
                            <TableBody>
                                {filteredOrders.map((order) => (
                                    <TableRow key={order.id}>
                                        ...
                                        <TableCell>
                                            {order.retailer?.businessName || 'Unknown'}
                                        </TableCell>
                                        <TableCell>
